...
# -*- coding: utf-8 -*-
"""
生成增强版的完整Jupyter Notebook文件
包含：完整分析流程、表格输出、图表、详细说明
"""
import json
...
# 保存文件
with open('public/notebooks/rfm-analysis.ipynb', 'w', encoding='utf-8') as f:
    json.dump(rfm_notebook, f, ensure_ascii=False, indent=1)

print("✅ 增强版RFM分析Notebook已生成！")
print(f"   - 共10个cell（5个markdown + 5个code）")
print(f"   - 包含完整的数据分析流程")
print(f"   - 包含表格输出和图表")
print(f"   - 包含详细的业务建议")
